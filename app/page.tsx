        ...
        <div className="container  grid grid-cols-2 items-center  gap-8">
          <div className="left grid gap-4">
            <div className="flex items-center gap-2">
              ...
              <p className="text-white text-[24px] font-normal italic  ">
                Welcome to Pages
              </p>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <p className="underline underline-offset-4  text-[19px] text-white font-bold">
                Read Free Demo
              </p>
            </div>
            <div className="grid grid-cols-3 ">
              ...
              <div className="flex ">
                ...
                <div>
                  ...
                  <p className="text-[18px] text-[#B4C7E7] ">
                    4.5/5 (305 ratings)
                  </p>
                </div>
              </div>
